...
public:
    static void FuncLoadFromFileTest(){
        for (int i = 1; i<7; i++) {
            ...
            GraphFileInterface<TMark, TRoad, TAttributes>::LoadGraphFromFile(graph, vertices, "Tests/temps/test"+std::to_string(i)+".txt");
    ...
    static void FuncDijkstraTest(){
        ...
        GraphFileInterface<TMark, TRoad, TAttributes>::LoadGraphFromFile(graph, vertices, "Tests/temps/test1.txt");
